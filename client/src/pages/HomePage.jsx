    ...
    {/* Navbar with humberger menu */}
     ...
     <Flex
      ...
      <Flex mt="90px">
        ...
        Nutrimeter encourages you to not just count your<br/> calories but to focus on your nutrition as a whole.
        </Text>
        </Flex>
        {/* section-3 ends here */}
      ...
      <Flex mt="120px">
        ...
        <Flex w={{base:"60%", md:"70%", lg:"50%"}} m="auto" textAlign={"center"} mt="15px">
        <Text fontSize={{ base: "18px", md: "20px", lg: "24px" }} color="black.600" m={"auto"}>
        Sync Nutrimeter with these activity trackers, Apple Health, Google Fit and Samsung Health.
        </Text>
        </Flex>
        <Flex>
